...
export default function SlushTriageDashboard() {
  ...
  const fetchProfiles = async () => {
    ...
    if (profilesData) {
      const mappedLeads = profilesData.map(db => ({
        ...
        // FIX: Explicitly separate the short bio and the long message
        bio: db.slush_bio || "",
  ...
  // Filter ONLY leads that have been scored AND are not declined (passed)
          ...
          <div className="max-w-4xl mx-auto p-10 relative z-10">
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                {/* NEW: Display the short bio right under the header badges */}
                {selectedLead.bio && (
            ...
            <div className="bg-zinc-900/30 backdrop-blur-md rounded-sm border border-zinc-800 overflow-hidden mb-8">
              <div className="bg-zinc-950 px-6 py-4 flex justify-between items-center border-b border-zinc-800">
                <h3 className="text-orange-500 font-bold uppercase tracking-widest flex items-center text-sm">
                  <Sparkles size={18} className="mr-2 text-orange-400" />
